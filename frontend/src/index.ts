...
export const goldsrcAddonsPlugin: PluginDefinition = {
    ...
    translations: {
        en: {
            ...
            file_hint_amxx: 'Compiled .amxx files are supported',
            file_hint_metamod: '.so and .dll binaries are supported',
            sma_rejected:
                '.sma files are sources. Compile the plugin into .amxx (e.g. with the AMX Mod X web compiler) and upload the result.',
            wrong_type_amxx: 'An .amxx file is required',
        ...
        ru: {
            ...
            file_hint_amxx: 'Поддерживаются готовые .amxx файлы',
            file_hint_metamod: 'Поддерживаются бинарники .so и .dll',
            sma_rejected:
                'Файлы .sma — исходники. Скомпилируйте плагин в .amxx (например, веб-компилятором AMX Mod X) и загрузите готовый файл.',
            wrong_type_amxx: 'Нужен файл .amxx',
